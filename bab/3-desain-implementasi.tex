...
\begin{figure}[H]
  ...
  \resizebox{0.9\linewidth}{!}{
    \begin{tikzpicture}[node distance=2cm]
      ...
      \node (getframe) [io, text width=4cm, below of=init] {Ambil Frame dari Kamera};
      ...
      \node (bbox) [io, text width=4cm, below of=mediapipe] {Menampilkan \textit{bounding box} dan pose};
      ...
      \node (turnback) [io, text width=4cm, below of=avoid] {Berbelok kembali sesuai arah terakhir};
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[node distance=2cm]
    ...
    \node (move) [io, text width=4cm, right of=getMsg, xshift=8.5cm] {Menggerakkan Motor Kursi Roda};    
